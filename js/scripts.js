...
$(function() {
    var browserStats = {
        ...
        getDocumentHeight: function(){   return $(document).height() },
        getDocumentWidth: function(){    return $(document).width() },
        getActualDimensions: function(dimension, ratio) { return dimension * ratio; },
        display: function() {
    ...
    jQuery(document).mouseleave(function(){browserStats.display();});
    jQuery(document).mouseenter(function(){browserStats.display();});
